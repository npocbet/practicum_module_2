...
@router.get('/{film_id}', response_model=Film, description="Film detail informations", summary="Get full film info by id(uuid)")
...
@router.get('', response_model=AllShortFilms, summary="All films with main info")
...
@router.get('/search/', response_model=AllShortFilms, summary="Search match films from words in query")
...
@router.get('/genre_top_films/{genre_id}', response_model=AllShortFilms, summary='Returns top films from genre (uuid)')
